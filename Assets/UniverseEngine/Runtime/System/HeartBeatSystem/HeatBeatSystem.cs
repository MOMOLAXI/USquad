...
namespace UniverseEngine
{
    ...
    internal class HeartBeatSystem : EngineSystem
    {
        readonly LinkedPool<HeartBeat> m_HeartBeatPool = new(() => new());
        readonly LinkedPool<CountBeat> m_CountBeatPool = new(() => new());
        ...
        public void RegisterCountBeat(string callbackName,
        ...
        public void RegisterHeartBeat(string callbackName,
