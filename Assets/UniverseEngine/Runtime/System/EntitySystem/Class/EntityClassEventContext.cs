...
namespace UniverseEngine
{
    ...
    {
        List<EntityClassEventContext> m_Children = new();
        ...
        public void RegisterEvent(EntityEvent eventType, EntityEventCallBack eventCallBack)
        {
            ...
            if (!Collections.IsValidIndex(EventSet, index))
            {
            ...
            {
                EntityClassEventContext child = m_Children[i];
        ...
        public void ExecuteEvent(EntityEvent eventType, EntityID self, EntityID sender, Args args)
        {
            int index = (int)eventType;
            if (!Collections.IsValidIndex(EventSet, index))
            {
