...
namespace UniverseEngine
{
    public class Entity : MonoBehaviour
    {
        ...
        public bool GetPropList(Args messageArgs)
        {
            if (!messageArgs.IsValid)
            {
                return false;
            }
            ...
            {
                messageArgs = messageArgs < property;
            }
        ...
        public void SetBool(string propName, bool value)
        {
            ...
            if (property.Value.GetBool() == value)
            {
                return;
            }
        ...
        public void SetInt(string propName, int value)
        {
            ...
            if (property.Value.GetInt() == value)
            {
                return;
            }
        ...
        public void SetInt64(string propName, long value)
        {
            ...
            if (property.Value.GetInt64() == value)
            {
                return;
            }
        ...
        public void SetFloat(string propName, float value)
        {
            ...
            if (Math.Abs(property.Value.GetFloat() - value) < 0.001f)
            {
                return;
            }
        ...
        public void SetDouble(string propName, double value)
        {
            ...
            if (Math.Abs(property.Value.GetDouble() - value) < 0.0001f)
            {
                return;
            }
        ...
        public void SetString(string propName, string value)
        {
            ...
            if (property.Value.GetString().Equals(value, StringComparison.InvariantCultureIgnoreCase))
            {
                return;
            }
        ...
        public void SetEntityID(string propName, EntityID value)
        {
            ...
            if (property.Value.GetEntityID() == value)
            {
                return;
            }
        ...
        public void SetObject(string propName, object value)
        {
            ...
            if (property.Value.GetObject() == value)
            {
                return;
            }
        ...
        public void SetClass<T>(string propName, T value) where T : class
        {
            ...
            if (property.Value.GetRawClass<T>() == value)
            {
                return;
            }
        ...
        public void SetBinary(string propName, byte[] value)
        {
            ...
            if (property.Value.GetBinary() == value)
            {
                return;
            }
        ...
        public EntityID GetEntityID(string propName)
        {
            ...
            return property.Value.GetEntityID();
        }
        ...
        internal void SendClassEvent(EntityEvent logicEvent, EntityID sender, Args args)
        {
        ...
        internal void AddChildren(List<Entity> entitys)
        {
            ...
            {
                entity.Parent = this;
                entity.SendClassEvent(EntityEvent.OnEntryOther, ID, Args.Empty);
            }

            Children.AddRange(entitys);
            SendClassEvent(EntityEvent.OnAddChildren, ID, Args.Empty);
            SendClassEvent(EntityEvent.OnCapacityChange, ID, Args.Empty);
        }
        ...
        internal void AddChild(Entity entity)
        {
            ...
            Children.Add(entity);
            SendClassEvent(EntityEvent.OnAddChild, entity.ID, Args.Empty);
            SendClassEvent(EntityEvent.OnCapacityChange, entity.ID, Args.Empty);
            entity.SendClassEvent(EntityEvent.OnEntryOther, ID, Args.Empty);
        }
        ...
        internal void RemoveChild(Entity entity, bool destroy = false)
        {
            ...
            SendClassEvent(EntityEvent.OnRemoveChild, entity.ID, Args.Empty);
            SendClassEvent(EntityEvent.OnCapacityChange, entity.ID, Args.Empty);
            entity.SendClassEvent(EntityEvent.OnLeaveOther, ID, Args.Empty);
        ...
        {
            return Collections.IsValidIndex(Children, index) ? Children[index].ID : EntityID.Invalid;
        }
        ...
        /// <returns></returns>
        public int GetChildren(Args result)
        {
            result.Clear();
        ...
        public void OnDestroySelf()
        {
            ...
            SendClassEvent(EntityEvent.OnDestroy, ID, Args.Empty);
        }
