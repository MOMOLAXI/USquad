...
namespace UniverseEngine
{
    ...
    public struct Var
    {
        ...
        public string GetString()
        {
            ...
            if (m_RefData is not StringBuffer sc)
            {
                return m_RefData as string;
            }
        ...
        {
            return VariableType != VarType.Object ? EntityID.Invalid : m_Value.m_ValueEntity;
        }
        ...
        public T GetRawClass<T>() where T : class
        {
            return VariableType != VarType.UserData ? null : m_RefData as T;
        }
        ...
        public Var(EntityID value)
        {
            ...
            Flag = VarFlag.None;
            m_RefData = null;
            m_Value = new() { m_ValueEntity = value };
        }
        ...
        bool IsEmptyString()
        {
            ...
            return m_RefData is not StringBuffer sc || sc.IsEmpty(m_Value.ValueInt32);
        }
    }
}
