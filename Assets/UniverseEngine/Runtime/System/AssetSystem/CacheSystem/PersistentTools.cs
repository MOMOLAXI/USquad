...
// 				_sandboxPath = StringUtilities.Format("{0}/Sandbox", projectPath);
// 			}
...
// 			{
// 				_buildinPath = StringUtilities.Format("{0}/{1}", UnityEngine.Application.streamingAssetsPath, FileSystem.STREAMING_ASSETS_BUILTIN_FOLDER);
// 			}
// 			return StringUtilities.Format("{0}/{1}", _buildinPath, path);
// 		}
//
// 		/// <summary>
// 		/// 获取基于沙盒文件夹的加载路径
...
// 			return StringUtilities.Format("{0}/{1}", root, path);
// 		}
//
// 		/// <summary>
// 		/// 获取WWW加载本地资源的路径
...
// 		{
// 			string fileName = FileSystem.GetManifestBinaryFileName(packageName, packageVersion);
...
// 		{
// 			string fileName = FileSystem.GetPackageHashFileName(packageName, packageVersion);
// 			return MakePersistentLoadPath($"{ManifestFolderName}/{fileName}");
// 		}
//
// 		/// <summary>
...
// 		{
// 			string fileName = FileSystem.GetPackageVersionFileName(packageName);
// 			return MakePersistentLoadPath($"{ManifestFolderName}/{fileName}");
// 		}
//
// 		/// <summary>
...
// 			FileSystem.CreateFile(filePath, version);
// 		}
// 	}
// }