...
namespace UniverseEngine
{
	...
	{	
		...
		public bool ActivateScene()
		{
			...
			{
				Log<AssetSystem>.Warning($"Scene is invalid or not loaded : {SceneObject.name}");
				return false;
			}
		}
		...
		public bool IsMainScene()
		{
			...
			{
				DatabaseSceneProvider temp = Provider as DatabaseSceneProvider;
		...
		public UnloadSceneOperation UnloadAsync()
		{
			...
			if (IsValidWithWarning == false)
			{
				...
				UnloadSceneOperation operation = new UnloadSceneOperation(error);
			...
			{
				UnloadSceneOperation operation = new UnloadSceneOperation(sceneObject);
				OperationSystem.StartOperation(operation);
				return operation;
			}
		}
