...
namespace UniverseEngine
{
    public class ObjectCache<T> where T : Component
    {
        ...
        /// </summary>
        public bool AutoUnactive
        {
            set => m_AutoUnactive = value;
        }
        ...
        public void Start(Transform parent, T template)
        {
            if (null == parent)
            {
                Log.Error("Object cache parent is null");
                return;
            }

            if (null == template)
            {
                Log.Error("Object cache template is null");
                return;
            }
        ...
        public T Get()
        {
            if (!m_IsInited)
            {
                Log.Warning("ObjectCache is not start.");
                return null;
            }
