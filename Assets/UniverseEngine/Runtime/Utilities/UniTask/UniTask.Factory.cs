...
namespace UniverseEngine
{
    public partial struct UniTask
    {
        ...
        {
            return new(new CanceledResultSource(CancellationToken.None), 0);
        })();
        ...
        {
            return new(new DeferPromise(factory), 0);
        }
        ...
        {
            return new(new DeferPromise<T>(factory), 0);
        }
        ...
        {
            return new(new NeverPromise<T>(cancellationToken), 0);
        }
    ...
    {
        public static readonly UniTask<AsyncUnit> AsyncUnit = UniTask.FromResult(global::UniverseEngine.AsyncUnit.Default);
