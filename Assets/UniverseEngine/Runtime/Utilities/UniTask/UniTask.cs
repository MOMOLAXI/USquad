...
namespace UniverseEngine
{
    ...
    public readonly partial struct UniTask
    {
        ...
        public UniTask<AsyncUnit> AsAsyncUnitUniTask()
        {
            ...
            {
                return new(asyncUnitSource, token);
            }
    ...
    public readonly struct UniTask<T>
    {
        ...
        public UniTaskStatus Status
        {
            [DebuggerHidden]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => source?.GetStatus(token) ?? UniTaskStatus.Succeeded;
        }
        ...
        /// <summary>
        /// Memorizing inner IValueTaskSource. The result UniTask can await multiple.
        /// </summary>
