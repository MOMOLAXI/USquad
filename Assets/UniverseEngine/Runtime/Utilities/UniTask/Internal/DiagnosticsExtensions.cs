...
namespace UniverseEngine
{
    internal static class DiagnosticsExtensions
    {
        ...
        static string BeautifyType(Type t, bool shortName)
        {
            ...
            if (!t.IsGenericType) return shortName ? t.Name : t.FullName.Replace("Universe.", "").Replace("Universe.", "").Replace("Universe.", "") ?? t.Name;
            ...
            return typeBeautifyRegex.Replace(genericType, "").Replace("Universe.", "").Replace("Universe.", "").Replace("Universe.", "") + "<" + innerFormat + ">";
        }
        ...
        static bool IgnoreLine(MethodBase methodInfo)
        {
            ...
            if (declareType.StartsWith("Universe.CompilerServices"))
            {
                return true;
            }
            ...
            if (declareType.StartsWith("Universe.UniTaskCompletionSourceCore"))
            {
                return true;
            }
            if (declareType.StartsWith("Universe.AwaiterActions"))
            {
                return true;
            }
