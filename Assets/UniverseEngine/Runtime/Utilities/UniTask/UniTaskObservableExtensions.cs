...
namespace UniverseEngine
{
    public static class UniTaskObservableExtensions
    {
        ...
        /// <summary>
        /// Ideally returns IObservabl[Unit] is best but Universe does not have Unit so return AsyncUnit instead.
        /// </summary>
...
namespace UniverseEngine
{
    ...
    sealed internal class SingleAssignmentDisposable : IDisposable
    {
    ...
    sealed internal class AsyncSubject<T> : IObservable<T>, IObserver<T>
    {
            ...
            lock (observerLock)
            {
                ...
                if (!isStopped)
                {
                    ...
                    else
                    {
                        ...
                        {
                            outObserver = new ListObserver<T>(new(new[] { current, observer }));
                        }
                    }
