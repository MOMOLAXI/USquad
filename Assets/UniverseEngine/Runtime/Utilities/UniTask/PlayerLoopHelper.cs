...
namespace UniverseEngine
{
	...
	public static class PlayerLoopHelper
	{
		...
		private static int FindLoopSystemIndex(PlayerLoopSystem[] playerLoopList, Type systemType)
		{
			...
			throw new("Target PlayerLoopSystem does not found. Type:" + systemType.FullName);
		}

		static void InsertLoop(PlayerLoopSystem[] copyList,
		                       ...
		                       PlayerLoopTiming playerLoopTiming)
		{
			...
			{
				copyList[i].subSystemList = InsertRunner(copyList[i],
				                                         injectOnFirst,
				                                         loopRunnerYieldType,
				                                         yielders[index] = new(playerLoopTiming),
				                                         loopRunnerType, 
				                                         runners[index] = new(playerLoopTiming));
			}
			else
			{
