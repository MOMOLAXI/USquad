...
namespace UniverseEngine
{
    ...
    public interface IUniTaskOrderedAsyncEnumerable<out TElement> : IUniTaskAsyncEnumerable<TElement>
    {
    ...
    public readonly struct UniTaskCancelableAsyncEnumerable<T>
    {
        ...
        {
            return new(enumerable.GetAsyncEnumerator(cancellationToken));
        }
