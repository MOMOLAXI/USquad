...
using Subscribes = UniverseEngine.Subscribe;
...
namespace UniverseEngine
{
    public static partial class UniTaskAsyncEnumerable
    {
        ...
        public static IDisposable Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Action<TSource> action)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeCore(source, action, global::UniverseEngine.Subscribe.NopError, global::UniverseEngine.Subscribe.NopCompleted, cts.Token).Forget();
            return cts;
        }
        ...
        public static void Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Action<TSource> action, CancellationToken cancellationToken)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeCore(source, action, global::UniverseEngine.Subscribe.NopError, global::UniverseEngine.Subscribe.NopCompleted, cancellationToken).Forget();
        }
        ...
        public static IDisposable SubscribeAwait<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Func<TSource, UniTask> onNext)
        {
            ...
            var cts = new CancellationTokenDisposable();
            global::UniverseEngine.Subscribe.SubscribeAwaitCore(source, onNext, global::UniverseEngine.Subscribe.NopError, global::UniverseEngine.Subscribe.NopCompleted, cts.Token).Forget();
            return cts;
        }
        ...
        public static void SubscribeAwait<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Func<TSource, UniTask> onNext, CancellationToken cancellationToken)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeAwaitCore(source, onNext, global::UniverseEngine.Subscribe.NopError, global::UniverseEngine.Subscribe.NopCompleted, cancellationToken).Forget();
        }
        ...
        public static IDisposable Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Action<TSource> onNext, Action<Exception> onError)
        {
            ...
            var cts = new CancellationTokenDisposable();
            global::UniverseEngine.Subscribe.SubscribeCore(source, onNext, onError, global::UniverseEngine.Subscribe.NopCompleted, cts.Token).Forget();
            return cts;
        }
        ...
        public static void Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Action<TSource> onNext, Action<Exception> onError, CancellationToken cancellationToken)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeCore(source, onNext, onError, global::UniverseEngine.Subscribe.NopCompleted, cancellationToken).Forget();
        }
        ...
        public static IDisposable SubscribeAwait<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Func<TSource, UniTask> onNext, Action<Exception> onError)
        {
            ...
            var cts = new CancellationTokenDisposable();
            global::UniverseEngine.Subscribe.SubscribeAwaitCore(source, onNext, onError, global::UniverseEngine.Subscribe.NopCompleted, cts.Token).Forget();
            return cts;
        }
        ...
        public static void SubscribeAwait<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Func<TSource, UniTask> onNext, Action<Exception> onError, CancellationToken cancellationToken)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeAwaitCore(source, onNext, onError, global::UniverseEngine.Subscribe.NopCompleted, cancellationToken).Forget();
        }
        ...
        public static IDisposable Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Action<TSource> onNext, Action onCompleted)
        {
            ...
            var cts = new CancellationTokenDisposable();
            global::UniverseEngine.Subscribe.SubscribeCore(source, onNext, global::UniverseEngine.Subscribe.NopError, onCompleted, cts.Token).Forget();
            return cts;
        }
        ...
        public static void Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Action<TSource> onNext, Action onCompleted, CancellationToken cancellationToken)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeCore(source, onNext, global::UniverseEngine.Subscribe.NopError, onCompleted, cancellationToken).Forget();
        }
        ...
        public static IDisposable SubscribeAwait<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Func<TSource, UniTask> onNext, Action onCompleted)
        {
            ...
            var cts = new CancellationTokenDisposable();
            global::UniverseEngine.Subscribe.SubscribeAwaitCore(source, onNext, global::UniverseEngine.Subscribe.NopError, onCompleted, cts.Token).Forget();
            return cts;
        }
        ...
        public static void SubscribeAwait<TSource>(this IUniTaskAsyncEnumerable<TSource> source, Func<TSource, UniTask> onNext, Action onCompleted, CancellationToken cancellationToken)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeAwaitCore(source, onNext, global::UniverseEngine.Subscribe.NopError, onCompleted, cancellationToken).Forget();
        }
        ...
        public static IDisposable Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, IObserver<TSource> observer)
        {
            ...
            var cts = new CancellationTokenDisposable();
            global::UniverseEngine.Subscribe.SubscribeCore(source, observer, cts.Token).Forget();
            return cts;
        }
        ...
        public static void Subscribe<TSource>(this IUniTaskAsyncEnumerable<TSource> source, IObserver<TSource> observer, CancellationToken cancellationToken)
        {
            ...
            global::UniverseEngine.Subscribe.SubscribeCore(source, observer, cancellationToken).Forget();
        }
    }

    sealed internal class CancellationTokenDisposable : IDisposable
    {
