...
namespace UniverseEngine
{
    ...
    sealed internal class Distinct<TSource> : IUniTaskAsyncEnumerable<TSource>
    {
    ...
    sealed internal class Distinct<TSource, TKey> : IUniTaskAsyncEnumerable<TSource>
    {
        readonly IUniTaskAsyncEnumerable<TSource> source;
    ...
    sealed internal class DistinctAwait<TSource, TKey> : IUniTaskAsyncEnumerable<TSource>
    {
        readonly IUniTaskAsyncEnumerable<TSource> source;
    ...
    sealed internal class DistinctAwaitWithCancellation<TSource, TKey> : IUniTaskAsyncEnumerable<TSource>
    {
        readonly IUniTaskAsyncEnumerable<TSource> source;
