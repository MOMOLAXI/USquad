...
namespace UniverseEngine
{
    ...
    public partial struct UniTask
    {
        public static YieldAwaitable Yield()
        {
            ...
            return new(PlayerLoopTiming.Update);
        }
        ...
        {
            return new(YieldPromise.Create(PlayerLoopTiming.Update, cancellationToken, out var token), token);
        }

        public static UniTask Yield(PlayerLoopTiming timing, CancellationToken cancellationToken)
        {
            return new(YieldPromise.Create(timing, cancellationToken, out var token), token);
        }
        ...
        {
            return new(NextFramePromise.Create(PlayerLoopTiming.Update, CancellationToken.None, out var token), token);
        }
        ...
        {
            return new(NextFramePromise.Create(timing, CancellationToken.None, out var token), token);
        }
        ...
        {
            return new(NextFramePromise.Create(PlayerLoopTiming.Update, cancellationToken, out var token), token);
        }
        ...
        {
            return new(NextFramePromise.Create(timing, cancellationToken, out var token), token);
        }
        ...
        public static UniTask DelayFrame(int delayFrameCount, PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new(DelayFramePromise.Create(delayFrameCount, delayTiming, cancellationToken, out var token), token);
        }
        ...
        public static UniTask Delay(TimeSpan delayTimeSpan, DelayType delayType, PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            switch (delayType)
            {
                case DelayType.UnscaledDeltaTime:
                    {
                        return new(DelayIgnoreTimeScalePromise.Create(delayTimeSpan, delayTiming, cancellationToken, out var token), token);
                    }
                case DelayType.Realtime:
                    {
                        return new(DelayRealtimePromise.Create(delayTimeSpan, delayTiming, cancellationToken, out var token), token);
                    }
                case DelayType.DeltaTime:
                default:
                    {
                        return new(DelayPromise.Create(delayTimeSpan, delayTiming, cancellationToken, out var token), token);
                    }
            }
        }
