...
namespace UniverseEngine
{
    public partial struct UniTask
    {
        ...
        {
            return new(PlayerLoopTiming.Update, cancellationToken);
        }
        ...
        {
            return new(timing, cancellationToken);
        }
        ...
        {
            return new(synchronizationContext, false, cancellationToken);
        }
        ...
        {
            return new(SynchronizationContext.Current, dontPostWhenSameContext, cancellationToken);
        }
    }
    ...
    public struct ReturnToMainThread
    {
        ...
        {
            return new(playerLoopTiming, cancellationToken); // run immediate.
        }
    ...
    public struct ReturnToSynchronizationContext
    {
        ...
        public Awaiter DisposeAsync()
        {
            return new(syncContext, dontPostWhenSameContext, cancellationToken);
        }
